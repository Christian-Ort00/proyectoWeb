...
public void addViewControllers(ViewControllerRegistry registry) {
    ...
    // Suele usarse sin el slash inicial en el view name:
...
public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http
        ...
        .formLogin(form -> form
            ...
            .defaultSuccessUrl("/index", true) // siempre manda a /index tras login
            .failureUrl("/login?error")        // en fallo, vuelve al login con ?error
        )
